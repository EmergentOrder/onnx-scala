...
trait ORTWebOperatorBackend {
  ...
  def runModel[
       ...
       sess: scala.scalajs.js.Promise[typings.onnxruntimeCommon.inferenceSessionMod.InferenceSession],
  ...
  def test() = {
      ...
      val session: scala.scalajs.js.Promise[typings.onnxruntimeCommon.inferenceSessionMod.InferenceSession] = OrtSession.create("squeezenet1.1.onnx")
//      val dataTypes = new FloatType {}
      ...
      val tensor: OnnxTensor[Float]  = (new OnnxTensor(rawData, dims)).asInstanceOf[OnnxTensor[Float]]
