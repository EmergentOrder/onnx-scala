...
/** Value of type A or B (union type).
  *
  * Scala does not have union types, but they are important to many interoperability scenarios. This
  * type provides a (partial) encoding of union types using implicit evidences.
  */
