...
package object onnx {
  ...
  trait Acosh extends Operator {
    ...
    def Acosh9[@sp T: Numeric: ClassTag](
        name: String,
  ...
  trait Asinh extends Operator {
    ...
    def Asinh9[@sp T: Numeric: ClassTag](
        name: String,
        input: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Atanh extends Operator {
    ...
    def Atanh9[@sp T: Numeric: ClassTag](
        name: String,
        input: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Div extends Operator {
    ...
    def Div7[@sp T: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]]
    )(
  ...
  trait GlobalMaxPool extends Operator {
    ...
    def GlobalMaxPool1[@sp T: Numeric: ClassTag](
        name: String,
        X: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Identity extends Operator {
    ...
    def Identity1[@sp T: Numeric: ClassTag](
        name: String,
        input: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
  ...
  trait MatMul extends Operator {
    ...
    def MatMul1[@sp T: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]]
    )(
    ...
    def MatMul9[@sp T: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]]
    )(
  ...
  trait Mean extends Operator {
    ...
    def Mean6[@sp T: Numeric: ClassTag](
        name: String,
        data_0: Seq[Option[Tensor[T]]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
    ...
    def Mean8[@sp T: Numeric: ClassTag](
        name: String,
        data_0: Seq[Option[Tensor[T]]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Pow extends Operator {
    ...
    def Pow7[@sp T: Numeric: ClassTag](
        name: String,
        X: Option[Tensor[T]],
        Y: Option[Tensor[T]]
    )(
  ...
  trait Reciprocal extends Operator {
    ...
    def Reciprocal6[@sp T: Numeric: ClassTag](
        name: String,
        X: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Softsign extends Operator {
    ...
    def Softsign1[@sp T: Numeric: ClassTag](
        name: String,
        input: Option[Tensor[T]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
  ...
  trait Sub extends Operator {
    ...
    def Sub7[@sp T: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]]
    )(
  ...
  trait Sum extends Operator {
    ...
    def Sum6[@sp T: Numeric: ClassTag](
        name: String,
        data_0: Seq[Option[Tensor[T]]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
    ...
    def Sum8[@sp T: Numeric: ClassTag](
        name: String,
        data_0: Seq[Option[Tensor[T]]]
    )(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T]
