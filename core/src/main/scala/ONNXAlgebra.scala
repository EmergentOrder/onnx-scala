...
package object onnx {
  ...
  import UnionType._
  trait DataSource {
    def inputData[T: Numeric: ClassTag](
    ...
    def getParams[T: Numeric: ClassTag](name: String)(
        implicit ev: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): Tensor[T]
    def getAttributes[T: Numeric: ClassTag](name: String)(
        implicit ev: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): Tensor[T]
  }
  ...
  trait Add extends Operator {
    ...
    def Add1[@sp T: Numeric: ClassTag](name: String,
    ...
    def Add6[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
    ...
    def Add7[@sp T: Numeric: ClassTag](name: String,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): (Tensor[T])
  ...
  trait Affine extends Operator {
    ...
    def Affine1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait And extends Operator {
    ...
    def And1[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        ...
        evT1: (UNil TypeOr Boolean)#check[T1]): (Tensor[T1])
  ...
  trait ArgMax extends Operator {
    ...
    def ArgMax1[@sp T: Numeric: ClassTag](name: String,
                                          axis: Option[(Int)] = None,
  ...
  trait ArgMin extends Operator {
    ...
    def ArgMin1[@sp T: Numeric: ClassTag](name: String,
                                          axis: Option[(Int)] = None,
                                          keepdims: Option[(Int)] = None,
                                          data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait Binarizer extends Operator {
    ...
    def Binarizer1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait CategoryMapper extends Operator {
    ...
    def CategoryMapper1[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        ...
        evT2: (UNil TypeOr String TypeOr Long)#check[T2]): (Tensor[T2])

  }
  trait Ceil extends Operator {

    def Ceil1[@sp T: Numeric: ClassTag](name: String,
                                        consumed_inputs: Option[(Array[Int])] =
                                          None,
                                        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Clip extends Operator {
    ...
    def Clip1[@sp T: Numeric: ClassTag](name: String,
                                        consumed_inputs: Option[(Array[Int])] =
                                          None,
    ...
    def Clip6[@sp T: Numeric: ClassTag](name: String,
                                        max: Option[(Float)] = None,
                                        min: Option[(Float)] = None,
                                        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Constant extends Operator {
    ...
    def Constant1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait ConstantFill extends Operator {
    ...
    def ConstantFill1[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
  ...
  trait Crop extends Operator {
    ...
    def Crop1[@sp T: Numeric: ClassTag](name: String,
                                        border: Option[(Array[Int])] = None,
                                        scaleAttr: Option[(Array[Int])] = None,
                                        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait DepthToSpace extends Operator {
    ...
    def DepthToSpace1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait Div extends Operator {
    ...
    def Div1[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
    ...
    def Div6[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
    ...
    def Div7[@sp T: Numeric: ClassTag](name: String,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): (Tensor[T])
  ...
  trait Dropout extends Operator {
    ...
    def Dropout7[@sp T: Numeric: ClassTag](name: String,
                                           ratio: Option[(Float)] = None,
                                           data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T], Tensor[T])
  ...
  trait Elu extends Operator {
    ...
    def Elu1[@sp T: Numeric: ClassTag](name: String,
                                       alpha: Option[(Float)] = None,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
                                       X: Option[Tensor[T]])(
    ...
    def Elu6[@sp T: Numeric: ClassTag](name: String,
                                       alpha: Option[(Float)] = None,
                                       X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Exp extends Operator {
    ...
    def Exp1[@sp T: Numeric: ClassTag](name: String,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
                                       input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Expand extends Operator {
    ...
    def Expand8[@sp T: Numeric: ClassTag](name: String,
                                          input: Option[Tensor[T]],
  ...
  trait Flatten extends Operator {
    ...
    def Flatten1[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Floor extends Operator {
    ...
    def Floor1[@sp T: Numeric: ClassTag](name: String,
                                         consumed_inputs: Option[(Array[Int])] =
                                           None,
                                         X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait GRU extends Operator {
    ...
    def GRU1[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        ...
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
        evT1: (UNil TypeOr Int)#check[T1]): (Tensor[T], Tensor[T])
  ...
  trait GRUUnit extends Operator {
    ...
    def GRUUnit1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait Gather extends Operator {
    ...
    def Gather1[@sp T: Numeric: ClassTag, @sp Tind: Numeric: ClassTag](
        ...
        evTind: (UNil TypeOr Int TypeOr Long)#check[Tind]): (Tensor[T])

  }
  trait Gemm extends Operator {

    def Gemm1[@sp T: Numeric: ClassTag](name: String,
                                        alpha: Option[(Float)] = None,
                                        beta: Option[(Float)] = None,
                                        broadcast: Option[(Int)] = None,
    ...
    def Gemm6[@sp T: Numeric: ClassTag](name: String,
                                        alpha: Option[(Float)] = None,
                                        beta: Option[(Float)] = None,
                                        broadcast: Option[(Int)] = None,
                                        transA: Option[(Int)] = None,
    ...
    def Gemm7[@sp T: Numeric: ClassTag](name: String,
                                        alpha: Option[(Float)] = None,
                                        beta: Option[(Float)] = None,
                                        transA: Option[(Int)] = None,
                                        transB: Option[(Int)] = None,
  ...
  trait GivenTensorFill extends Operator {
    ...
    def GivenTensorFill1[@sp T: Numeric: ClassTag](
        name: String,
        extra_shape: Option[(Array[Int])] = None,
        input_as_shape: Option[(Int)] = None,
        shape: Option[(Array[Int])] = None,
  ...
  trait GlobalAveragePool extends Operator {
    ...
    def GlobalAveragePool1[@sp T: Numeric: ClassTag](name: String,
                                                     X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait GlobalLpPool extends Operator {
    ...
    def GlobalLpPool1[@sp T: Numeric: ClassTag](name: String,
                                                p: Option[(Float)] = None,
                                                X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def GlobalLpPool2[@sp T: Numeric: ClassTag](name: String,
                                                p: Option[(Int)] = None,
                                                X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait GlobalMaxPool extends Operator {
    ...
    def GlobalMaxPool1[@sp T: Numeric: ClassTag](name: String,
                                                 X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait HardSigmoid extends Operator {
    ...
    def HardSigmoid6[@sp T: Numeric: ClassTag](name: String,
                                               alpha: Option[(Float)] = None,
                                               beta: Option[(Float)] = None,
                                               X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Hardmax extends Operator {
    ...
    def Hardmax1[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Identity extends Operator {
    ...
    def Identity1[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): (Tensor[T])
  ...
  trait If extends Operator {
    ...
    def If1[@sp B: Numeric: ClassTag, @sp V: Numeric: ClassTag](
        ...
        evV: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[V]): (Tensor[V])

  }
  trait ImageScaler extends Operator {

    def ImageScaler1[@sp T: Numeric: ClassTag](
        name: String,
  ...
  trait LRN extends Operator {
    ...
    def LRN1[@sp T: Numeric: ClassTag](name: String,
                                       alpha: Option[(Float)] = None,
                                       beta: Option[(Float)] = None,
  ...
  trait LSTM extends Operator {
    ...
    def LSTM1[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        ...
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
        evT1: (UNil TypeOr Int)#check[T1]): (Tensor[T], Tensor[T], Tensor[T])
  ...
  trait LeakyRelu extends Operator {
    ...
    def LeakyRelu6[@sp T: Numeric: ClassTag](name: String,
                                             alpha: Option[(Float)] = None,
                                             X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Log extends Operator {
    ...
    def Log1[@sp T: Numeric: ClassTag](name: String,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
                                       input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait LogSoftmax extends Operator {
    ...
    def LogSoftmax1[@sp T: Numeric: ClassTag](name: String,
                                              axis: Option[(Int)] = None,
                                              input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Loop extends Operator {
    ...
    def Loop1[@sp I: Numeric: ClassTag,
  ...
  trait LpNormalization extends Operator {
    ...
    def LpNormalization1[@sp T: Numeric: ClassTag](name: String,
                                                   axis: Option[(Int)] = None,
                                                   p: Option[(Int)] = None,
                                                   input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait LpPool extends Operator {
    ...
    def LpPool1[@sp T: Numeric: ClassTag](name: String,
                                          auto_pad: Option[(String)] = None,
                                          kernel_shape: Option[(Array[Int])] =
                                            None,
                                          p: Option[(Float)] = None,
    ...
    def LpPool2[@sp T: Numeric: ClassTag](name: String,
                                          auto_pad: Option[(String)] = None,
                                          kernel_shape: Option[(Array[Int])],
                                          p: Option[(Int)] = None,
                                          pads: Option[(Array[Int])] = None,
  ...
  trait MatMul extends Operator {
    ...
    def MatMul1[@sp T: Numeric: ClassTag](name: String,
                                          A: Option[Tensor[T]],
                                          B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Max extends Operator {
    ...
    def Max6[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def Max8[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Mean extends Operator {
    ...
    def Mean6[@sp T: Numeric: ClassTag](name: String,
                                        data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def Mean8[@sp T: Numeric: ClassTag](name: String,
                                        data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait MeanVarianceNormalization extends Operator {
    ...
    def MeanVarianceNormalization1[@sp T: Numeric: ClassTag](
        name: String,
  ...
  trait Min extends Operator {
    ...
    def Min6[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def Min8[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Mul extends Operator {
    ...
    def Mul1[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
    ...
    def Mul6[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
    ...
    def Mul7[@sp T: Numeric: ClassTag](name: String,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): (Tensor[T])
  ...
  trait Multinomial extends Operator {
    ...
    def Multinomial7[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        ...
        implicit evT1: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T1],
        evT2: (UNil TypeOr Int TypeOr Long)#check[T2]): (Tensor[T2])

  }
  trait Neg extends Operator {

    def Neg1[@sp T: Numeric: ClassTag](name: String,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
                                       X: Option[Tensor[T]])(
  ...
  trait Normalizer extends Operator {
    ...
    def Normalizer1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait PRelu extends Operator {
    ...
    def PRelu1[@sp T: Numeric: ClassTag](name: String,
                                         consumed_inputs: Option[(Array[Int])] =
                                           None,
                                         X: Option[Tensor[T]],
    ...
    def PRelu6[@sp T: Numeric: ClassTag](name: String,
                                         X: Option[Tensor[T]],
                                         slope: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def PRelu7[@sp T: Numeric: ClassTag](name: String,
                                         X: Option[Tensor[T]],
                                         slope: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Pad extends Operator {
    ...
    def Pad1[@sp T: Numeric: ClassTag](name: String,
    ...
    def Pad2[@sp T: Numeric: ClassTag](name: String,
                                       mode: Option[(String)] = None,
  ...
  trait ParametricSoftplus extends Operator {
    ...
    def ParametricSoftplus1[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        beta: Option[(Float)] = None,
        X: Option[Tensor[T]])(
  ...
  trait Pow extends Operator {
    ...
    def Pow1[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       X: Option[Tensor[T]],
                                       Y: Option[Tensor[T]])(
    ...
    def Pow7[@sp T: Numeric: ClassTag](name: String,
                                       X: Option[Tensor[T]],
                                       Y: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait RandomNormal extends Operator {
    ...
    def RandomNormal1[@sp T: Numeric: ClassTag](name: String,
                                                dtype: Option[(Int)] = None,
                                                mean: Option[(Float)] = None,
                                                scaleAttr: Option[(Float)] =
                                                  None,
                                                seed: Option[(Float)] = None,
  ...
  trait RandomUniform extends Operator {
    ...
    def RandomUniform1[@sp T: Numeric: ClassTag](name: String,
                                                 dtype: Option[(Int)] = None,
  ...
  trait RandomUniformLike extends Operator {
    ...
    def RandomUniformLike1[@sp T1: Numeric: ClassTag,
  ...
  trait Reciprocal extends Operator {
    ...
    def Reciprocal6[@sp T: Numeric: ClassTag](name: String,
                                              X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait ReduceL1 extends Operator {
    ...
    def ReduceL11[@sp T: Numeric: ClassTag](name: String,
  ...
  trait ReduceL2 extends Operator {
    ...
    def ReduceL21[@sp T: Numeric: ClassTag](name: String,
                                            axes: Option[(Array[Int])] = None,
                                            keepdims: Option[(Int)] = None,
                                            data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait ReduceLogSum extends Operator {
    ...
    def ReduceLogSum1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait ReduceMax extends Operator {
    ...
    def ReduceMax1[@sp T: Numeric: ClassTag](name: String,
                                             axes: Option[(Array[Int])] = None,
                                             keepdims: Option[(Int)] = None,
                                             data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait ReduceMean extends Operator {
    ...
    def ReduceMean1[@sp T: Numeric: ClassTag](name: String,
                                              axes: Option[(Array[Int])] = None,
                                              keepdims: Option[(Int)] = None,
                                              data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait ReduceMin extends Operator {
    ...
    def ReduceMin1[@sp T: Numeric: ClassTag](name: String,
                                             axes: Option[(Array[Int])] = None,
                                             keepdims: Option[(Int)] = None,
                                             data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait ReduceProd extends Operator {
    ...
    def ReduceProd1[@sp T: Numeric: ClassTag](name: String,
                                              axes: Option[(Array[Int])] = None,
                                              keepdims: Option[(Int)] = None,
                                              data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait ReduceSum extends Operator {
    ...
    def ReduceSum1[@sp T: Numeric: ClassTag](name: String,
                                             axes: Option[(Array[Int])] = None,
                                             keepdims: Option[(Int)] = None,
                                             data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  trait Scale extends Operator {
    ...
    def Scale1[@sp T: Numeric: ClassTag](name: String,
                                         scaleAttr: Option[(Float)] = None,
                                         input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait ScaledTanh extends Operator {
    ...
    def ScaledTanh1[@sp T: Numeric: ClassTag](name: String,
                                              alpha: Option[(Float)] = None,
                                              beta: Option[(Float)] = None,
                                              input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Scaler extends Operator {
    ...
    def Scaler1[@sp T: Numeric: ClassTag](name: String,
                                          offset: Option[(Array[Float])] = None,
                                          scaleAttr: Option[(Array[Float])] =
                                            None,
                                          X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float TypeOr Double TypeOr Long TypeOr Int)#check[
          T]): (Tensor[Float])
  ...
  trait Selu extends Operator {
    ...
    def Selu1[@sp T: Numeric: ClassTag](name: String,
                                        alpha: Option[(Float)] = None,
                                        consumed_inputs: Option[(Array[Int])] =
                                          None,
    ...
    def Selu6[@sp T: Numeric: ClassTag](name: String,
                                        alpha: Option[(Float)] = None,
                                        gamma: Option[(Float)] = None,
                                        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Shape extends Operator {
    ...
    def Shape1[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        ...
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T],
        evT1: (UNil TypeOr Long)#check[T1]): (Tensor[T1])
  ...
  trait Slice extends Operator {
    ...
    def Slice1[@sp T: Numeric: ClassTag](name: String,
                                         axes: Option[(Array[Int])] = None,
  ...
  trait Softmax extends Operator {
    ...
    def Softmax1[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Softsign extends Operator {
    ...
    def Softsign1[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait SpaceToDepth extends Operator {
    ...
    def SpaceToDepth1[@sp T: Numeric: ClassTag](name: String,
                                                blocksize: Option[(Int)],
                                                input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): (Tensor[T])
  ...
  trait Split extends Operator {
    ...
    def Split1[@sp T: Numeric: ClassTag](name: String,
                                         axis: Option[(Int)] = None,
    ...
    def Split2[@sp T: Numeric: ClassTag](name: String,
                                         axis: Option[(Int)] = None,
                                         splitAttr: Option[(Array[Int])] = None,
                                         input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
  ...
  trait Sqrt extends Operator {
    ...
    def Sqrt1[@sp T: Numeric: ClassTag](name: String,
                                        consumed_inputs: Option[(Array[Int])] =
                                          None,
                                        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Squeeze extends Operator {
    ...
    def Squeeze1[@sp T: Numeric: ClassTag](name: String,
                                           axes: Option[(Array[Int])] = None,
                                           data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): (Tensor[T])
  ...
  trait Sub extends Operator {
    ...
    def Sub1[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       consumed_inputs: Option[(Array[Int])] =
                                         None,
    ...
    def Sub6[@sp T: Numeric: ClassTag](name: String,
                                       axis: Option[(Int)] = None,
                                       broadcast: Option[(Int)] = None,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
    ...
    def Sub7[@sp T: Numeric: ClassTag](name: String,
                                       A: Option[Tensor[T]],
                                       B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): (Tensor[T])
  ...
  trait Sum extends Operator {
    ...
    def Sum6[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])

    def Sum8[@sp T: Numeric: ClassTag](name: String,
                                       data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : (Tensor[T])
  ...
  trait Tanh extends Operator {
    ...
    def Tanh1[@sp T: Numeric: ClassTag](name: String,
                                        consumed_inputs: Option[(Array[Int])] =
                                          None,
                                        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait ThresholdedRelu extends Operator {
    ...
    def ThresholdedRelu1[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  trait Tile extends Operator {
    ...
    def Tile1[@sp T: Numeric: ClassTag](name: String,
                                        input: Option[Tensor[T]],
    ...
    def Tile6[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        ...
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T],
        evT1: (UNil TypeOr Long)#check[T1]): (Tensor[T])
  ...
  trait Transpose extends Operator {
    ...
    def Transpose1[@sp T: Numeric: ClassTag](name: String,
  ...
  trait TreeEnsembleClassifier extends Operator {
    ...
    def TreeEnsembleClassifier1[@sp T1: Numeric: ClassTag,
                                @sp T2: Numeric: ClassTag](
        name: String,
  ...
  trait Unsqueeze extends Operator {
    ...
    def Unsqueeze1[@sp T: Numeric: ClassTag](name: String,
                                             axes: Option[(Array[Int])],
                                             data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): (Tensor[T])
  ...
  trait Upsample extends Operator {
    ...
    def Upsample1[@sp T: Numeric: ClassTag](name: String,
    ...
    def Upsample7[@sp T: Numeric: ClassTag](name: String,
                                            mode: Option[(String)] = None,
