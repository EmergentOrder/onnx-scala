...
trait Squeezenet {
  ...
  def program[
    ...
    for {
      ...
      nodesqueezenet0_conv0_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv0_weight"))
      nodesqueezenet0_conv0_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv0_bias"))
      nodesqueezenet0_conv1_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv1_weight"))
      nodesqueezenet0_conv1_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv1_bias"))
      nodesqueezenet0_conv2_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv2_weight"))
      nodesqueezenet0_conv2_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv2_bias"))
      nodesqueezenet0_conv3_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv3_weight"))
      nodesqueezenet0_conv3_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv3_bias"))
      nodesqueezenet0_conv4_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv4_weight"))
      nodesqueezenet0_conv4_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv4_bias"))
      nodesqueezenet0_conv5_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv5_weight"))
      nodesqueezenet0_conv5_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv5_bias"))
      nodesqueezenet0_conv6_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv6_weight"))
      nodesqueezenet0_conv6_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv6_bias"))
      nodesqueezenet0_conv7_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv7_weight"))
      nodesqueezenet0_conv7_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv7_bias"))
      nodesqueezenet0_conv8_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv8_weight"))
      nodesqueezenet0_conv8_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv8_bias"))
      nodesqueezenet0_conv9_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv9_weight"))
      nodesqueezenet0_conv9_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv9_bias"))
      nodesqueezenet0_conv10_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv10_weight"))
      nodesqueezenet0_conv10_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv10_bias"))
      nodesqueezenet0_conv11_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv11_weight"))
      nodesqueezenet0_conv11_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv11_bias"))
      nodesqueezenet0_conv12_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv12_weight"))
      nodesqueezenet0_conv12_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv12_bias"))
      nodesqueezenet0_conv13_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv13_weight"))
      nodesqueezenet0_conv13_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv13_bias"))
      nodesqueezenet0_conv14_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv14_weight"))
      nodesqueezenet0_conv14_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv14_bias"))
      nodesqueezenet0_conv15_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv15_weight"))
      nodesqueezenet0_conv15_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv15_bias"))
      nodesqueezenet0_conv16_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv16_weight"))
      nodesqueezenet0_conv16_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv16_bias"))
      nodesqueezenet0_conv17_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv17_weight"))
      nodesqueezenet0_conv17_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv17_bias"))
      nodesqueezenet0_conv18_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv18_weight"))
      nodesqueezenet0_conv18_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv18_bias"))
      nodesqueezenet0_conv19_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv19_weight"))
      nodesqueezenet0_conv19_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv19_bias"))
      nodesqueezenet0_conv20_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv20_weight"))
      nodesqueezenet0_conv20_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv20_bias"))
      nodesqueezenet0_conv21_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv21_weight"))
      nodesqueezenet0_conv21_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv21_bias"))
      nodesqueezenet0_conv22_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv22_weight"))
      nodesqueezenet0_conv22_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv22_bias"))
      nodesqueezenet0_conv23_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv23_weight"))
      nodesqueezenet0_conv23_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv23_bias"))
      nodesqueezenet0_conv24_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv24_weight"))
      nodesqueezenet0_conv24_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv24_bias"))
      nodesqueezenet0_conv25_weight <- List(
        dataSource.getParams[T]("squeezenet0_conv25_weight"))
      nodesqueezenet0_conv25_bias <- List(
        dataSource.getParams[T]("squeezenet0_conv25_bias"))
      nodereshape_attr_tensor118 <- List(
        dataSource.getParams[Long]("reshape_attr_tensor118"))
      ...
      nodesqueezenet0_relu0_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu0_fwd",
                      X = Some(nodesqueezenet0_conv0_fwd)))
      nodesqueezenet0_pool0_fwd <- List(
        MaxPool.MaxPool1[T]("squeezenet0_pool0_fwd",
                            kernel_shape = Some((Array(3, 3))),
                            pads = Some((Array(0, 0, 0, 0))),
                            strides = Some((Array(2, 2))),
      ...
      nodesqueezenet0_relu1_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu1_fwd",
      ...
      nodesqueezenet0_relu2_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu2_fwd",
      ...
      nodesqueezenet0_relu3_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu3_fwd",
                      X = Some(nodesqueezenet0_conv3_fwd)))
      nodesqueezenet0_concat0 <- List(
        Concat.Concat4[T]("squeezenet0_concat0",
                          axis = Some((1)),
      ...
      nodesqueezenet0_relu4_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu4_fwd",
      ...
      nodesqueezenet0_relu5_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu5_fwd",
      ...
      nodesqueezenet0_relu7_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu7_fwd",
      ...
      nodesqueezenet0_relu8_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu8_fwd",
      ...
      nodesqueezenet0_relu9_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu9_fwd",
                      X = Some(nodesqueezenet0_conv9_fwd)))
      nodesqueezenet0_concat2 <- List(
        Concat.Concat4[T]("squeezenet0_concat2",
                          axis = Some((1)),
      ...
      nodesqueezenet0_relu10_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu10_fwd",
      ...
      nodesqueezenet0_relu11_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu11_fwd",
      ...
      nodesqueezenet0_relu13_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu13_fwd",
      ...
      nodesqueezenet0_relu14_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu14_fwd",
      ...
      nodesqueezenet0_relu15_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu15_fwd",
                      X = Some(nodesqueezenet0_conv15_fwd)))
      nodesqueezenet0_concat4 <- List(
        Concat.Concat4[T]("squeezenet0_concat4",
                          axis = Some((1)),
      ...
      nodesqueezenet0_relu16_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu16_fwd",
      ...
      nodesqueezenet0_relu17_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu17_fwd",
      ...
      nodesqueezenet0_relu18_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu18_fwd",
                      X = Some(nodesqueezenet0_conv18_fwd)))
      nodesqueezenet0_concat5 <- List(
        Concat.Concat4[T]("squeezenet0_concat5",
                          axis = Some((1)),
      ...
      nodesqueezenet0_relu19_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu19_fwd",
      ...
      nodesqueezenet0_relu20_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu20_fwd",
      ...
      nodesqueezenet0_relu21_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu21_fwd",
                      X = Some(nodesqueezenet0_conv21_fwd)))
      nodesqueezenet0_concat6 <- List(
        Concat.Concat4[T]("squeezenet0_concat6",
                          axis = Some((1)),
      ...
      nodesqueezenet0_relu22_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu22_fwd",
      ...
      nodesqueezenet0_relu23_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu23_fwd",
      ...
      nodesqueezenet0_relu25_fwd <- List(
        Relu.Relu6[T]("squeezenet0_relu25_fwd",
                      X = Some(nodesqueezenet0_conv25_fwd)))
      nodesqueezenet0_pool3_fwd <- List(
        AveragePool.AveragePool7[T]("squeezenet0_pool3_fwd",
      ...
      nodesqueezenet0_flatten0_reshape0 <- List(
        Reshape.Reshape5[T]("squeezenet0_flatten0_reshape0",
