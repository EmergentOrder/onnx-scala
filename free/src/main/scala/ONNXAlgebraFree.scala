...
package object onnxFree {
  ...
  @free trait DataSourceFree extends DataSource {
    def inputDataFree[T: Numeric: ClassTag](
        implicit ev: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[Tensor[T]]
    def getParamsFree[T: Numeric: ClassTag](name: String)(
        implicit ev: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[Tensor[T]]
    def getAttributesFree[T: Numeric: ClassTag](name: String)(
        implicit ev: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[Tensor[T]]
  }
  @free trait AbsFree extends Operator with Abs {

    def Abs1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait AcosFree extends Operator with Acos {
    ...
    def Acos7Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait AddFree extends Operator with Add {
    ...
    def Add1Free[@sp T: Numeric: ClassTag](
        name: String,
    ...
    def Add6Free[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           broadcast: Option[(Int)] = None,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
    ...
    def Add7Free[@sp T: Numeric: ClassTag](name: String,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): FS[(Tensor[T])]
  ...
  @free trait AffineFree extends Operator with Affine {
    ...
    def Affine1Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait AndFree extends Operator with And {
    ...
    def And1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
        ...
        evT1: (UNil TypeOr Boolean)#check[T1]): FS[(Tensor[T1])]

    def And7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Boolean)#check[T],
  ...
  @free trait ArgMaxFree extends Operator with ArgMax {
    ...
    def ArgMax1Free[@sp T: Numeric: ClassTag](name: String,
                                              axis: Option[(Int)] = None,
  ...
  @free trait ArgMinFree extends Operator with ArgMin {
    ...
    def ArgMin1Free[@sp T: Numeric: ClassTag](name: String,
                                              axis: Option[(Int)] = None,
                                              keepdims: Option[(Int)] = None,
                                              data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
  ...
  @free trait ArrayFeatureExtractorFree
      extends Operator
      with ArrayFeatureExtractor {

    def ArrayFeatureExtractor1Free[@sp T: Numeric: ClassTag](
        name: String,
        X: Option[Tensor[T]],
        Y: Option[Tensor[Long]])(
        implicit evT: (UNil TypeOr Float TypeOr Double TypeOr Long TypeOr Int TypeOr String)#check[
          T]): FS[(Tensor[T])]

  }
  @free trait AsinFree extends Operator with Asin {

    def Asin7Free[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait AtanFree extends Operator with Atan {
    ...
    def Atan7Free[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait AveragePoolFree extends Operator with AveragePool {
    ...
    def AveragePool1Free[@sp T: Numeric: ClassTag](
        name: String,
    ...
    def AveragePool7Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
  ...
  @free trait BatchNormalizationFree extends Operator with BatchNormalization {
    ...
    def BatchNormalization1Free[@sp T: Numeric: ClassTag](
        name: String,
    ...
    def BatchNormalization6Free[@sp T: Numeric: ClassTag](
        name: String,
        epsilon: Option[(Float)] = None,
        is_test: Option[(Int)] = None,
        momentum: Option[(Float)] = None,
    ...
    def BatchNormalization7Free[@sp T: Numeric: ClassTag](
        name: String,
        epsilon: Option[(Float)] = None,
        momentum: Option[(Float)] = None,
        spatial: Option[(Int)] = None,
  ...
  @free trait BinarizerFree extends Operator with Binarizer {
    ...
    def Binarizer1Free[@sp T: Numeric: ClassTag](name: String,
                                                 threshold: Option[(Float)] =
                                                   None,
                                                 X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float TypeOr Double TypeOr Long TypeOr Int)#check[
          T]): FS[(Tensor[T])]

  }
  @free trait CastFree extends Operator with Cast {

    def Cast1Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
        to: Option[(String)],
    ...
    def Cast6Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
        to: Option[(Int)],
        input: Option[Tensor[T1]])(
        implicit evT1: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Boolean)#check[
  ...
  @free trait CastMapFree extends Operator with CastMap {
    ...
    def CastMap1Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
        cast_to: Option[(String)] = None,
        map_form: Option[(String)] = None,
        max_map: Option[(Int)] = None,
        X: Option[T1])(implicit evT1: (UNil TypeOr Map[Long, String] TypeOr Map[
                         Long,
                         Float])#check[T1],
                       evT2: (UNil TypeOr String TypeOr Float TypeOr Long)#check[
                         T2]): FS[(Tensor[T2])]

  }
  @free trait CategoryMapperFree extends Operator with CategoryMapper {

    def CategoryMapper1Free[@sp T1: Numeric: ClassTag,
        ...
        evT2: (UNil TypeOr String TypeOr Long)#check[T2]): FS[(Tensor[T2])]

  }
  @free trait CeilFree extends Operator with Ceil {

    def Ceil1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait ClipFree extends Operator with Clip {
    ...
    def Clip1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def Clip6Free[@sp T: Numeric: ClassTag](name: String,
                                            max: Option[(Float)] = None,
                                            min: Option[(Float)] = None,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait ConcatFree extends Operator with Concat {
    ...
    def Concat4Free[@sp T: Numeric: ClassTag](name: String,
                                              axis: Option[(Int)],
  ...
  @free trait ConstantFillFree extends Operator with ConstantFill {
    ...
    def ConstantFill1Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
        extra_shape: Option[(Array[Int])] = None,
        input_as_shape: Option[(Int)] = None,
        shape: Option[(Array[Int])] = None,
        value: Option[(Float)] = None,
        input: Option[Tensor[T1]] = None)(
        implicit evT1: (UNil TypeOr Float TypeOr Int TypeOr Long TypeOr Boolean)#check[
          T1],
        evT2: (UNil TypeOr Float TypeOr Int TypeOr Long TypeOr Boolean)#check[
          T2]): FS[(Tensor[T2])]

  }
  @free trait ConstantFree extends Operator with Constant {

    def Constant1Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait ConvFree extends Operator with Conv {
    ...
    def Conv1Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
  ...
  @free trait ConvTransposeFree extends Operator with ConvTranspose {
    ...
    def ConvTranspose1Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
        dilations: Option[(Array[Int])] = None,
        group: Option[(Int)] = None,
  ...
  @free trait CosFree extends Operator with Cos {
    ...
    def Cos7Free[@sp T: Numeric: ClassTag](name: String,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait CropFree extends Operator with Crop {
    ...
    def Crop1Free[@sp T: Numeric: ClassTag](name: String,
                                            border: Option[(Array[Int])] = None,
                                            scaleAttr: Option[(Array[Int])] =
                                              None,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait DepthToSpaceFree extends Operator with DepthToSpace {
    ...
    def DepthToSpace1Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait DictVectorizerFree extends Operator with DictVectorizer {
    ...
    def DictVectorizer1Free[@sp T1: Numeric: ClassTag,
                            @sp T2: Numeric: ClassTag](
        name: String,
        ...
        implicit evT1: (UNil TypeOr Map[String, Long] TypeOr Map[Long, String] TypeOr Map[
          Long,
          Float] TypeOr Map[Long, Double] TypeOr Map[String, Float] TypeOr Map[
          String,
          Double])#check[T1],
        evT2: (UNil TypeOr Long TypeOr Float TypeOr Double TypeOr String)#check[
          T2]): FS[(Tensor[T2])]

  }
  @free trait DivFree extends Operator with Div {

    def Div1Free[@sp T: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def Div6Free[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           broadcast: Option[(Int)] = None,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
    ...
    def Div7Free[@sp T: Numeric: ClassTag](name: String,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): FS[(Tensor[T])]
  ...
  @free trait DropoutFree extends Operator with Dropout {
    ...
    def Dropout1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        is_test: Option[(Int)] = None,
    ...
    def Dropout6Free[@sp T: Numeric: ClassTag](name: String,
                                               is_test: Option[(Int)] = None,
                                               ratio: Option[(Float)] = None,
                                               data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Dropout7Free[@sp T: Numeric: ClassTag](name: String,
                                               ratio: Option[(Float)] = None,
                                               data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T], Tensor[T])]
  ...
  @free trait EluFree extends Operator with Elu {
    ...
    def Elu1Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
    ...
    def Elu6Free[@sp T: Numeric: ClassTag](name: String,
                                           alpha: Option[(Float)] = None,
                                           X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait EqualFree extends Operator with Equal {
    ...
    def Equal1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
    ...
    def Equal7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Boolean TypeOr Int TypeOr Long)#check[T],
  ...
  @free trait ExpFree extends Operator with Exp {
    ...
    def Exp1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Exp6Free[@sp T: Numeric: ClassTag](name: String,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait ExpandFree extends Operator with Expand {
    ...
    def Expand8Free[@sp T: Numeric: ClassTag](name: String,
                                              input: Option[Tensor[T]],
  ...
  @free trait FlattenFree extends Operator with Flatten {
    ...
    def Flatten1Free[@sp T: Numeric: ClassTag](name: String,
                                               axis: Option[(Int)] = None,
                                               input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait FloorFree extends Operator with Floor {
    ...
    def Floor1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Floor6Free[@sp T: Numeric: ClassTag](name: String,
                                             X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GRUFree extends Operator with GRU {
    ...
    def GRU1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        ...
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
        evT1: (UNil TypeOr Int)#check[T1]): FS[(Tensor[T], Tensor[T])]

    def GRU3Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
    ...
    def GRU7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
  ...
  @free trait GRUUnitFree extends Operator with GRUUnit {
    ...
    def GRUUnit1Free[@sp T: Numeric: ClassTag](
        name: String,
        drop_states: Option[(Int)] = None,
        hidden_prev: Option[Tensor[T]],
        gates: Option[Tensor[T]],
        seq_lengths: Option[Tensor[T]],
        t: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GatherFree extends Operator with Gather {
    ...
    def Gather1Free[@sp T: Numeric: ClassTag, @sp Tind: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        data: Option[Tensor[T]],
        ...
        evTind: (UNil TypeOr Int TypeOr Long)#check[Tind]): FS[(Tensor[T])]

  }
  @free trait GemmFree extends Operator with Gemm {

    def Gemm1Free[@sp T: Numeric: ClassTag](name: String,
                                            alpha: Option[(Float)] = None,
                                            beta: Option[(Float)] = None,
                                            broadcast: Option[(Int)] = None,
    ...
    def Gemm6Free[@sp T: Numeric: ClassTag](name: String,
                                            alpha: Option[(Float)] = None,
                                            beta: Option[(Float)] = None,
                                            broadcast: Option[(Int)] = None,
                                            transA: Option[(Int)] = None,
    ...
    def Gemm7Free[@sp T: Numeric: ClassTag](name: String,
                                            alpha: Option[(Float)] = None,
                                            beta: Option[(Float)] = None,
                                            transA: Option[(Int)] = None,
                                            transB: Option[(Int)] = None,
  ...
  @free trait GivenTensorFillFree extends Operator with GivenTensorFill {
    ...
    def GivenTensorFill1Free[@sp T: Numeric: ClassTag](
        name: String,
        extra_shape: Option[(Array[Int])] = None,
        input_as_shape: Option[(Int)] = None,
        shape: Option[(Array[Int])] = None,
        values: Option[(Array[Float])] = None,
        shapeInput: Option[Tensor[T]] = None)(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GlobalAveragePoolFree extends Operator with GlobalAveragePool {
    ...
    def GlobalAveragePool1Free[@sp T: Numeric: ClassTag](name: String,
                                                         X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GlobalLpPoolFree extends Operator with GlobalLpPool {
    ...
    def GlobalLpPool1Free[@sp T: Numeric: ClassTag](name: String,
                                                    p: Option[(Float)] = None,
                                                    X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def GlobalLpPool2Free[@sp T: Numeric: ClassTag](name: String,
                                                    p: Option[(Int)] = None,
                                                    X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GlobalMaxPoolFree extends Operator with GlobalMaxPool {
    ...
    def GlobalMaxPool1Free[@sp T: Numeric: ClassTag](name: String,
                                                     X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait GreaterFree extends Operator with Greater {
    ...
    def Greater1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
    ...
    def Greater7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
  ...
  @free trait HardSigmoidFree extends Operator with HardSigmoid {
    ...
    def HardSigmoid1Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        beta: Option[(Float)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def HardSigmoid6Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        beta: Option[(Float)] = None,
        X: Option[Tensor[T]])(
  ...
  @free trait HardmaxFree extends Operator with Hardmax {
    ...
    def Hardmax1Free[@sp T: Numeric: ClassTag](name: String,
                                               axis: Option[(Int)] = None,
                                               input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait IdentityFree extends Operator with Identity {
    ...
    def Identity1Free[@sp T: Numeric: ClassTag](name: String,
                                                input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[(Tensor[T])]
  ...
  @free trait IfFree extends Operator with If {
    ...
    def If1Free[@sp B: Numeric: ClassTag, @sp V: Numeric: ClassTag](
        name: String,
        ...
        evV: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[V]): FS[(Tensor[V])]

  }
  @free trait ImageScalerFree extends Operator with ImageScaler {

    def ImageScaler1Free[@sp T: Numeric: ClassTag](
        name: String,
        bias: Option[(Array[Float])] = None,
  ...
  @free trait ImputerFree extends Operator with Imputer {
    ...
    def Imputer1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait InstanceNormalizationFree
      extends Operator
      with InstanceNormalization {

    def InstanceNormalization1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        epsilon: Option[(Float)] = None,
        input: Option[Tensor[T]],
    ...
    def InstanceNormalization6Free[@sp T: Numeric: ClassTag](
        name: String,
        epsilon: Option[(Float)] = None,
        input: Option[Tensor[T]],
        scale: Option[Tensor[T]],
  ...
  @free trait LRNFree extends Operator with LRN {
    ...
    def LRN1Free[@sp T: Numeric: ClassTag](name: String,
                                           alpha: Option[(Float)] = None,
                                           beta: Option[(Float)] = None,
  ...
  @free trait LSTMFree extends Operator with LSTM {
    ...
    def LSTM1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
    ...
    def LSTM7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
  ...
  @free trait LabelEncoderFree extends Operator with LabelEncoder {
    ...
    def LabelEncoder1Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
  ...
  @free trait LeakyReluFree extends Operator with LeakyRelu {
    ...
    def LeakyRelu1Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
    ...
    def LeakyRelu6Free[@sp T: Numeric: ClassTag](name: String,
                                                 alpha: Option[(Float)] = None,
                                                 X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait LessFree extends Operator with Less {
    ...
    def Less1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
    ...
    def Less7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
  ...
  @free trait LinearClassifierFree extends Operator with LinearClassifier {
    ...
    def LinearClassifier1Free[@sp T1: Numeric: ClassTag,
                              @sp T2: Numeric: ClassTag](
        name: String,
        ...
        X: Option[Tensor[T1]])(
        implicit evT1: (UNil TypeOr Float TypeOr Double TypeOr Long TypeOr Int)#check[
          T1],
        evT2: (UNil TypeOr String TypeOr Long)#check[T2])
      : FS[(Tensor[T2], Tensor[Float])]

  }
  @free trait LinearRegressorFree extends Operator with LinearRegressor {

    def LinearRegressor1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait LogFree extends Operator with Log {
    ...
    def Log1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Log6Free[@sp T: Numeric: ClassTag](name: String,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait LogSoftmaxFree extends Operator with LogSoftmax {
    ...
    def LogSoftmax1Free[@sp T: Numeric: ClassTag](name: String,
                                                  axis: Option[(Int)] = None,
                                                  input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait LoopFree extends Operator with Loop {
    ...
    def Loop1Free[@sp I: Numeric: ClassTag,
                  @sp B: Numeric: ClassTag,
                  @sp V: Numeric: ClassTag](name: String,
                                            body: Option[(Graph)],
                                            M: Option[I],
                                            cond: Option[B],
  ...
  @free trait LpNormalizationFree extends Operator with LpNormalization {
    ...
    def LpNormalization1Free[@sp T: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        p: Option[(Int)] = None,
        input: Option[Tensor[T]])(
  ...
  @free trait LpPoolFree extends Operator with LpPool {
    ...
    def LpPool1Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
        kernel_shape: Option[(Array[Int])] = None,
        p: Option[(Float)] = None,
    ...
    def LpPool2Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
        kernel_shape: Option[(Array[Int])],
        p: Option[(Int)] = None,
  ...
  @free trait MatMulFree extends Operator with MatMul {
    ...
    def MatMul1Free[@sp T: Numeric: ClassTag](name: String,
                                              A: Option[Tensor[T]],
                                              B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait MaxFree extends Operator with Max {
    ...
    def Max6Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def Max8Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait MaxPoolFree extends Operator with MaxPool {
    ...
    def MaxPool1Free[@sp T: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
        kernel_shape: Option[(Array[Int])],
        pads: Option[(Array[Int])] = None,
    ...
    def MaxPool8Free[@sp T: Numeric: ClassTag, @sp I: Numeric: ClassTag](
        name: String,
        auto_pad: Option[(String)] = None,
        kernel_shape: Option[(Array[Int])],
        pads: Option[(Array[Int])] = None,
        ...
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T],
        evI: (UNil TypeOr Long)#check[I]): FS[(Tensor[T], Tensor[I])]

  }
  @free trait MaxRoiPoolFree extends Operator with MaxRoiPool {

    def MaxRoiPool1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait MeanFree extends Operator with Mean {
    ...
    def Mean6Free[@sp T: Numeric: ClassTag](name: String,
                                            data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def Mean8Free[@sp T: Numeric: ClassTag](name: String,
                                            data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

  }
  @free trait MeanVarianceNormalizationFree
      extends Operator
      with MeanVarianceNormalization {

    def MeanVarianceNormalization1Free[@sp T: Numeric: ClassTag](
        name: String,
        across_channels: Option[(Int)] = None,
        normalize_variance: Option[(Int)] = None,
        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait MinFree extends Operator with Min {
    ...
    def Min6Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def Min8Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait MulFree extends Operator with Mul {
    ...
    def Mul1Free[@sp T: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def Mul6Free[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           broadcast: Option[(Int)] = None,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
    ...
    def Mul7Free[@sp T: Numeric: ClassTag](name: String,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): FS[(Tensor[T])]
  ...
  @free trait MultinomialFree extends Operator with Multinomial {
    ...
    def Multinomial7Free[@sp T1: Numeric: ClassTag, @sp T2: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
        sample_size: Option[(Int)] = None,
        seed: Option[(Float)] = None,
        input: Option[Tensor[T1]])(
        implicit evT1: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T1],
        evT2: (UNil TypeOr Int TypeOr Long)#check[T2]): FS[(Tensor[T2])]

  }
  @free trait NegFree extends Operator with Neg {

    def Neg1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
  ...
  @free trait NormalizerFree extends Operator with Normalizer {
    ...
    def Normalizer1Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait OneHotEncoderFree extends Operator with OneHotEncoder {
    ...
    def OneHotEncoder1Free[@sp T: Numeric: ClassTag](
        name: String,
        cats_int64s: Option[(Array[Int])] = None,
        cats_strings: Option[(Array[String])] = None,
        zeros: Option[(Int)] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr String TypeOr Long TypeOr Int TypeOr Float TypeOr Double)#check[
          T]): FS[(Tensor[Float])]

  }
  @free trait OrFree extends Operator with Or {

    def Or1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
    ...
    def Or7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Boolean)#check[T],
  ...
  @free trait PReluFree extends Operator with PRelu {
    ...
    def PRelu1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]],
    ...
    def PRelu6Free[@sp T: Numeric: ClassTag](name: String,
                                             X: Option[Tensor[T]],
                                             slope: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def PRelu7Free[@sp T: Numeric: ClassTag](name: String,
                                             X: Option[Tensor[T]],
                                             slope: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait PadFree extends Operator with Pad {
    ...
    def Pad1Free[@sp T: Numeric: ClassTag](name: String,
    ...
    def Pad2Free[@sp T: Numeric: ClassTag](name: String,
                                           mode: Option[(String)] = None,
  ...
  @free trait ParametricSoftplusFree extends Operator with ParametricSoftplus {
    ...
    def ParametricSoftplus1Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        beta: Option[(Float)] = None,
        X: Option[Tensor[T]])(
  ...
  @free trait PowFree extends Operator with Pow {
    ...
    def Pow1Free[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           broadcast: Option[(Int)] = None,
                                           X: Option[Tensor[T]],
                                           Y: Option[Tensor[T]])(
    ...
    def Pow7Free[@sp T: Numeric: ClassTag](name: String,
                                           X: Option[Tensor[T]],
                                           Y: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait RNNFree extends Operator with RNN {
    ...
    def RNN1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
    ...
    def RNN7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        activation_alpha: Option[(Array[Float])] = None,
        activation_beta: Option[(Array[Float])] = None,
        activations: Option[(Array[String])] = None,
  ...
  @free trait RandomNormalFree extends Operator with RandomNormal {
    ...
    def RandomNormal1Free[@sp T: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
  ...
  @free trait RandomNormalLikeFree extends Operator with RandomNormalLike {
    ...
    def RandomNormalLike1Free[@sp T1: Numeric: ClassTag,
                              @sp T2: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
        mean: Option[(Float)] = None,
        ...
        implicit evT1: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T1],
  ...
  @free trait RandomUniformFree extends Operator with RandomUniform {
    ...
    def RandomUniform1Free[@sp T: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
  ...
  @free trait RandomUniformLikeFree extends Operator with RandomUniformLike {
    ...
    def RandomUniformLike1Free[@sp T1: Numeric: ClassTag,
                               @sp T2: Numeric: ClassTag](
        name: String,
        dtype: Option[(Int)] = None,
        high: Option[(Float)] = None,
  ...
  @free trait ReciprocalFree extends Operator with Reciprocal {
    ...
    def Reciprocal1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Reciprocal6Free[@sp T: Numeric: ClassTag](name: String,
                                                  X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait ReduceL1Free extends Operator with ReduceL1 {
    ...
    def ReduceL11Free[@sp T: Numeric: ClassTag](name: String,
  ...
  @free trait ReduceL2Free extends Operator with ReduceL2 {
    ...
    def ReduceL21Free[@sp T: Numeric: ClassTag](name: String,
                                                axes: Option[(Array[Int])] =
                                                  None,
                                                keepdims: Option[(Int)] = None,
                                                data: Option[Tensor[T]])(
  ...
  @free trait ReduceLogSumExpFree extends Operator with ReduceLogSumExp {
    ...
    def ReduceLogSumExp1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait ReduceLogSumFree extends Operator with ReduceLogSum {
    ...
    def ReduceLogSum1Free[@sp T: Numeric: ClassTag](
        name: String,
        axes: Option[(Array[Int])] = None,
        keepdims: Option[(Int)] = None,
        data: Option[Tensor[T]])(
  ...
  @free trait ReduceMaxFree extends Operator with ReduceMax {
    ...
    def ReduceMax1Free[@sp T: Numeric: ClassTag](name: String,
                                                 axes: Option[(Array[Int])] =
                                                   None,
                                                 keepdims: Option[(Int)] = None,
                                                 data: Option[Tensor[T]])(
  ...
  @free trait ReduceMeanFree extends Operator with ReduceMean {
    ...
    def ReduceMean1Free[@sp T: Numeric: ClassTag](
        name: String,
        axes: Option[(Array[Int])] = None,
        keepdims: Option[(Int)] = None,
        data: Option[Tensor[T]])(
  ...
  @free trait ReduceMinFree extends Operator with ReduceMin {
    ...
    def ReduceMin1Free[@sp T: Numeric: ClassTag](name: String,
                                                 axes: Option[(Array[Int])] =
                                                   None,
                                                 keepdims: Option[(Int)] = None,
                                                 data: Option[Tensor[T]])(
  ...
  @free trait ReduceProdFree extends Operator with ReduceProd {
    ...
    def ReduceProd1Free[@sp T: Numeric: ClassTag](
        name: String,
        axes: Option[(Array[Int])] = None,
        keepdims: Option[(Int)] = None,
        data: Option[Tensor[T]])(
  ...
  @free trait ReduceSumFree extends Operator with ReduceSum {
    ...
    def ReduceSum1Free[@sp T: Numeric: ClassTag](name: String,
                                                 axes: Option[(Array[Int])] =
                                                   None,
                                                 keepdims: Option[(Int)] = None,
                                                 data: Option[Tensor[T]])(
  ...
  @free trait ReduceSumSquareFree extends Operator with ReduceSumSquare {
    ...
    def ReduceSumSquare1Free[@sp T: Numeric: ClassTag](
        name: String,
        axes: Option[(Array[Int])] = None,
        keepdims: Option[(Int)] = None,
        data: Option[Tensor[T]])(
  ...
  @free trait ReluFree extends Operator with Relu {
    ...
    def Relu1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait ReshapeFree extends Operator with Reshape {
    ...
    def Reshape1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        shape: Option[(Array[Int])] = None,
        data: Option[Tensor[T]])(
    ...
    def Reshape5Free[@sp T: Numeric: ClassTag](name: String,
                                               data: Option[Tensor[T]],
                                               shape: Option[Tensor[Long]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[(Tensor[T])]
  ...
  @free trait SVMClassifierFree extends Operator with SVMClassifier {
    ...
    def SVMClassifier1Free[@sp T1: Numeric: ClassTag,
                           @sp T2: Numeric: ClassTag](
        name: String,
        classlabels_ints: Option[(Array[Int])] = None,
        classlabels_strings: Option[(Array[String])] = None,
  ...
  @free trait SVMRegressorFree extends Operator with SVMRegressor {
    ...
    def SVMRegressor1Free[@sp T: Numeric: ClassTag](
        name: String,
        coefficients: Option[(Array[Float])] = None,
        kernel_params: Option[(Array[Float])] = None,
        kernel_type: Option[(String)] = None,
  ...
  @free trait ScaleFree extends Operator with Scale {
    ...
    def Scale1Free[@sp T: Numeric: ClassTag](name: String,
                                             scaleAttr: Option[(Float)] = None,
                                             input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait ScaledTanhFree extends Operator with ScaledTanh {
    ...
    def ScaledTanh1Free[@sp T: Numeric: ClassTag](name: String,
                                                  alpha: Option[(Float)] = None,
                                                  beta: Option[(Float)] = None,
                                                  input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait ScalerFree extends Operator with Scaler {
    ...
    def Scaler1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait SeluFree extends Operator with Selu {
    ...
    def Selu1Free[@sp T: Numeric: ClassTag](
        name: String,
        alpha: Option[(Float)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def Selu6Free[@sp T: Numeric: ClassTag](name: String,
                                            alpha: Option[(Float)] = None,
                                            gamma: Option[(Float)] = None,
                                            X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait ShapeFree extends Operator with Shape {
    ...
    def Shape1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T],
        evT1: (UNil TypeOr Long)#check[T1]): FS[(Tensor[T1])]

  }
  @free trait SigmoidFree extends Operator with Sigmoid {

    def Sigmoid1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Sigmoid6Free[@sp T: Numeric: ClassTag](name: String,
                                               X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait SinFree extends Operator with Sin {
    ...
    def Sin7Free[@sp T: Numeric: ClassTag](name: String,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait SizeFree extends Operator with Size {
    ...
    def Size1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T],
  ...
  @free trait SliceFree extends Operator with Slice {
    ...
    def Slice1Free[@sp T: Numeric: ClassTag](name: String,
                                             axes: Option[(Array[Int])] = None,
  ...
  @free trait SoftmaxFree extends Operator with Softmax {
    ...
    def Softmax1Free[@sp T: Numeric: ClassTag](name: String,
                                               axis: Option[(Int)] = None,
                                               input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait SoftplusFree extends Operator with Softplus {
    ...
    def Softplus1Free[@sp T: Numeric: ClassTag](name: String,
                                                X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait SoftsignFree extends Operator with Softsign {
    ...
    def Softsign1Free[@sp T: Numeric: ClassTag](name: String,
                                                input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait SpaceToDepthFree extends Operator with SpaceToDepth {
    ...
    def SpaceToDepth1Free[@sp T: Numeric: ClassTag](name: String,
                                                    blocksize: Option[(Int)],
                                                    input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[(Tensor[T])]
  ...
  @free trait SplitFree extends Operator with Split {
    ...
    def Split1Free[@sp T: Numeric: ClassTag](name: String,
                                             axis: Option[(Int)] = None,
                                             splitAttr: Option[(Array[Int])] =
                                               None,
                                             input: Option[Tensor[T]],
    ...
    def Split2Free[@sp T: Numeric: ClassTag](name: String,
                                             axis: Option[(Int)] = None,
                                             splitAttr: Option[(Array[Int])] =
                                               None,
                                             input: Option[Tensor[T]])(
  ...
  @free trait SqrtFree extends Operator with Sqrt {
    ...
    def Sqrt1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait SqueezeFree extends Operator with Squeeze {
    ...
    def Squeeze1Free[@sp T: Numeric: ClassTag](
        name: String,
        axes: Option[(Array[Int])] = None,
        data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
  ...
  @free trait SubFree extends Operator with Sub {
    ...
    def Sub1Free[@sp T: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        consumed_inputs: Option[(Array[Int])] = None,
    ...
    def Sub6Free[@sp T: Numeric: ClassTag](name: String,
                                           axis: Option[(Int)] = None,
                                           broadcast: Option[(Int)] = None,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
    ...
    def Sub7Free[@sp T: Numeric: ClassTag](name: String,
                                           A: Option[Tensor[T]],
                                           B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UInt TypeOr ULong TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double)#check[
          T]): FS[(Tensor[T])]
  ...
  @free trait SumFree extends Operator with Sum {
    ...
    def Sum6Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]

    def Sum8Free[@sp T: Numeric: ClassTag](name: String,
                                           data_0: Seq[Option[Tensor[T]]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait TanFree extends Operator with Tan {
    ...
    def Tan7Free[@sp T: Numeric: ClassTag](name: String,
                                           input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait TanhFree extends Operator with Tanh {
    ...
    def Tanh1Free[@sp T: Numeric: ClassTag](
        name: String,
        consumed_inputs: Option[(Array[Int])] = None,
        input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
    ...
    def Tanh6Free[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
      : FS[(Tensor[T])]
  ...
  @free trait ThresholdedReluFree extends Operator with ThresholdedRelu {
    ...
    def ThresholdedRelu1Free[@sp T: Numeric: ClassTag](name: String,
                                                       alpha: Option[(Float)] =
                                                         None,
                                                       X: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])
  ...
  @free trait TileFree extends Operator with Tile {
    ...
    def Tile1Free[@sp T: Numeric: ClassTag](name: String,
                                            input: Option[Tensor[T]],
    ...
    def Tile6Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        input: Option[Tensor[T]],
        repeats: Option[Tensor[T1]])(
        implicit evT: (UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T],
        evT1: (UNil TypeOr Long)#check[T1]): FS[(Tensor[T])]

  }
  @free trait TopKFree extends Operator with TopK {

    def TopK1Free[@sp T: Numeric: ClassTag, @sp I: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        k: Option[(Int)],
        X: Option[Tensor[T]])(
  ...
  @free trait TransposeFree extends Operator with Transpose {
    ...
    def Transpose1Free[@sp T: Numeric: ClassTag](name: String,
                                                 perm: Option[(Array[Int])] =
                                                   None,
                                                 data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[(Tensor[T])]
  ...
  @free trait TreeEnsembleClassifierFree
      extends Operator
      with TreeEnsembleClassifier {

    def TreeEnsembleClassifier1Free[@sp T1: Numeric: ClassTag,
                                    @sp T2: Numeric: ClassTag](
        name: String,
  ...
  @free trait TreeEnsembleRegressorFree
      extends Operator
      with TreeEnsembleRegressor {

    def TreeEnsembleRegressor1Free[@sp T: Numeric: ClassTag](
        name: String,
  ...
  @free trait UnsqueezeFree extends Operator with Unsqueeze {
    ...
    def Unsqueeze1Free[@sp T: Numeric: ClassTag](name: String,
                                                 axes: Option[(Array[Int])],
                                                 data: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr Float16 TypeOr Float TypeOr Double TypeOr String TypeOr Boolean TypeOr Complex[
          Float] TypeOr Complex[Double])#check[T]): FS[(Tensor[T])]
  ...
  @free trait UpsampleFree extends Operator with Upsample {
    ...
    def Upsample1Free[@sp T: Numeric: ClassTag](
        name: String,
    ...
    def Upsample7Free[@sp T: Numeric: ClassTag](
        name: String,
        mode: Option[(String)] = None,
  ...
  @free trait XorFree extends Operator with Xor {
    ...
    def Xor1Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        axis: Option[(Int)] = None,
        broadcast: Option[(Int)] = None,
        A: Option[Tensor[T]],
    ...
    def Xor7Free[@sp T: Numeric: ClassTag, @sp T1: Numeric: ClassTag](
        name: String,
        A: Option[Tensor[T]],
        B: Option[Tensor[T]])(
        implicit evT: (UNil TypeOr Boolean)#check[T],
  ...
  @free trait ZipMapFree extends Operator with ZipMap {
    ...
    def ZipMap1Free[@sp T: Numeric: ClassTag](
        name: String,
        classlabels_int64s: Option[(Array[Int])] = None,
        classlabels_strings: Option[(Array[String])] = None,
        X: Option[Tensor[Float]])(
        implicit evT: (UNil TypeOr Seq[Map[String, Float]] TypeOr Seq[
          Map[Long, Float]])#check[T]): FS[(T)]
