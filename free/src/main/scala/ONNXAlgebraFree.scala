...
package object onnxFree {
  ...
  def inputDataFree[T : Numeric:ClassTag](implicit ev:(UNil TypeOr Float16 TypeOr Float TypeOr Double TypeOr Byte TypeOr Short TypeOr Int TypeOr Long TypeOr UByte TypeOr UShort TypeOr UInt TypeOr ULong TypeOr Complex[Float] TypeOr Complex[Double])#check[T]): FS[Tensor[T]]
...
@free trait ConstantFillFree extends Operator with ConstantFill {
  ...
  def ConstantFill1Free[@sp T1 : Numeric:ClassTag,@sp T2 : Numeric:ClassTag](name: String,dtype : Option[(Int)] = None,extra_shape : Option[(Array[Int])] = None,input_as_shape : Option[(Int)] = None,shape : Option[(Array[Int])] = None,value : Option[(Float)] = None,input: Option[Tensor[T1]] = None)
...
@free trait LoopFree extends Operator with Loop {
  ...
  def Loop1Free[@sp I : Numeric:ClassTag,@sp B : Numeric:ClassTag,@sp V : Numeric:ClassTag](name: String,body : Option[(Graph)],M: Option[I], cond: Option[B],v_initial: Seq[Option[Tensor[V]]])
...
@free trait MeanVarianceNormalizationFree extends Operator with MeanVarianceNormalization {
  ...
  def MeanVarianceNormalization1Free[@sp T : Numeric:ClassTag](name: String,across_channels : Option[(Int)] = None,normalize_variance : Option[(Int)] = None,input: Option[Tensor[T]])
(implicit evT:(UNil TypeOr Float16 TypeOr Float TypeOr Double)#check[T])    : FS[(Tensor[T])]
