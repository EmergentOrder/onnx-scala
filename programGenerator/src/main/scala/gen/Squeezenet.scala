...
//TODO: Specify types so that MaxPool works out the box here
class Squeezenet(byteArray: Array[Byte]) {
  val Conv: Conv                           = new NGraphBackend(byteArray)
  val Relu: Relu                           = new NGraphBackend(byteArray)
  val MaxPool: MaxPool                     = new NGraphBackend(byteArray)
  val Concat: Concat                       = new NGraphBackend(byteArray)
  val Dropout: Dropout                     = new NGraphBackend(byteArray)
  val GlobalAveragePool: GlobalAveragePool = new NGraphBackend(byteArray)
  val Softmax: Softmax                     = new NGraphBackend(byteArray)
