addSbtPlugin("com.thesamet" % "sbt-protoc" % "1.0.8") //0.1.0-SNAPSHOT")
...
libraryDependencies += ("com.thesamet.scalapb" %% "compilerplugin" % "1.0.0-alpha.3") //+0-670082a5+20260212-1249-SNAPSHOT")
